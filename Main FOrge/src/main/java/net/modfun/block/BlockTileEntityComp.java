...
public class BlockTileEntityComp extends Block
{
  public BlockTileEntityComp()
  {
    super(Material.ROCK);
  ...
  @Override
  public TileEntity createTileEntity(World world, IBlockState state) {return new  TileEntityComp();}
  ...
  public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack) {
    ...
    if (tileentity instanceof TileEntityComp) { // prevent a crash if not the right type, or is null
      TileEntityComp TileEntityComp = (TileEntityComp)tileentity;
      TileEntityComp.setTicksLeftTillDisappear(TIMER_COUNTDOWN_TICKS);
    }
  }
