 ...
 */
public class TileEntitySpecialRendererCompressor extends TileEntitySpecialRenderer<TileEntityCompressor>
{
   ...
   */
  @Override
  public void render(TileEntityCompressor tileEntity, double relativeX, double relativeY, double relativeZ,
                     float partialTicks, int blockDamageProgress, float alpha) {

    if (!(tileEntity instanceof TileEntityCompressor)) return; // should never happen
    TileEntityCompressor tileEntityMBE21 = tileEntity;
    ...
    try {
      ...
      if (fullBrightnessColor != TileEntityCompressor.INVALID_COLOR) {
  ...
  @Override
  public boolean isGlobalRenderer(TileEntityCompressor tileEntityMBE21)
  {
    return false;
  }
